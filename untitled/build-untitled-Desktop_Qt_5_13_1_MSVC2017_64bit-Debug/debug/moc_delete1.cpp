...
void Delete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteNumber((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Delete::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Delete::deleteNumber)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Delete::deleteNumber(int _t1)
{
